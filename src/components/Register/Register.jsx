    ...
    <div>
      ...
      <div className="hero-content bg-gradient-to-r from-green-50 to-green-200 shadow-xl p-20 m-5 rounded flex-col lg:flex-row-reverse">
        ...
        <h2 className='text-5xl absolute top-36 ps-24 text-center text-green-500 font-bold'>
          Welcome</h2>
          <img className="w-[600px] rounded" src="https://img.freepik.com/free-vector/placeholder-concept-illustration_114360-4847.jpg" alt="" />
        </div>
        <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl shadow-green-600 bg-green-100">
          <div className="card-body">
            ...
            <h2 className="text-2xl ms-2 
                 font-serif font-semibold ">Register</h2>
            </div>
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text text-xl 
                 font-serif">Confirm Password</span>
              </label>
              <input
                type="password"
                name='confirm'
                placeholder="Confirm Password"
                {...register("confirm",{required: true,validate: (value) => value === watch('password')|| "Password didn't matched"})}
                className="input input-bordered bg-slate-200 font-semibold"
              />
           ...
           border-none rounded hover:bg-green-500" type="submit" value="Register"/>
            </div>
            <p className='text-center mt-3 font-serif'>Already have an account? <Link to="/login" className='text-green-500'>Login</Link> </p>
