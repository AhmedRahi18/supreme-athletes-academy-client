...
const Banner = () => {
  return (
    <div className="md:-mt-36 -mt-28">
        ...
        <div className="absolute inset-0 top-20 md:top-52 md:w-1/2 right-20 md:right-[500px]">
          <div className=" text-white p-4">
           <Fade>
           <h2 className="text-3xl md:text-6xl font-bold">Supreme <br /> <span className="text-lg  md:text-6xl">
            Athletes Academy
                </span></h2>
            <p className="text-gray-200 w-96 text-xs md:text-lg md:w-[600px] md:mt-5">Welcome to Athletes Academy, where champions are made! Make your summer full of joy with our premier sports training facility offers top-notch coaching and state-of-the-art facilities to help athletes of all ages and skill levels reach their full potential. Join us and experience the thrill of professional training, personalized guidance, and a supportive community that fosters growth and excellence. Unleash your inner athlete and embark on a journey of success with Athletes Academy!</p>
            <button className="btn btn-xs md:btn-md md:me-16 border-none bg-gradient-to-r from-green-600 to-green-800 hover:scale-90 rounded px-5 py-1 text-white font-bold md:mt-8">
                Read More
            </button>
           </Fade>
            <div className="w-96 md:visible invisible">
        ...
        <div className="absolute inset-0 top-20 md:top-52 md:w-1/2 right-20 md:right-[500px]">
          <div className=" text-white p-4">
           ...
           <h2 className="text-3xl md:text-6xl font-bold">Supreme <br /> <span className="text-lg  md:text-6xl">
            ...
            <p className="text-gray-200 w-96 text-xs md:text-lg md:w-[600px] md:mt-5">Welcome to Athletes Academy, where champions are made! Make your summer full of joy with our premier sports training facility offers top-notch coaching and state-of-the-art facilities to help athletes of all ages and skill levels reach their full potential. Join us and experience the thrill of professional training, personalized guidance, and a supportive community that fosters growth and excellence!</p>
            <button className="btn btn-xs md:btn-md md:me-16 border-none bg-gradient-to-r from-green-600 to-green-800 hover:scale-90 rounded px-5 py-1 text-white font-bold md:mt-8">
                Read More
            </button>
           </Fade>
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 top-20 md:top-52 md:w-1/2 right-20 md:right-[500px]">
          <div className=" text-white p-4">
            ...
            <div className="w-3/4 md:visible invisible">
