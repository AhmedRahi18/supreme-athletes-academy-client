  ...
  return (
    <div className="-mt-28">
      ...
      <div className="relative">
        <img className="brightness-75 rounded" src="https://static1.straitstimes.com.sg/s3fs-public/articles/2022/06/19/sv_soccer_190622.jpg?VersionId=Kc.KIwxtXNgeMvYUdWkGgwF8ej7boorb" />
        <div className="absolute inset-0 top-52 w-1/2 right-[500px]">
          <div className=" text-white p-4">
            ...
            <button className="btn me-16 border-none bg-gradient-to-r from-green-400 to-green-500 hover:scale-90 rounded px-5 py-1 text-white font-bold mt-8">
                Read More
            </button>
            <div className="w-96">
